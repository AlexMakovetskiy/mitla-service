...
import { API_BASE_URL, API_REGISTRATION_ENDPOINT } from '../../../utils/Main';
    ...
    return (
        <section className="signup-wrap medium-container">
            ...
            <div className="user-data-wrap" >
                <input type="text" name="email" className="user-data-wrap__email" placeholder="Email" onChange={handleChange} data-testid="email-element-test"/>
